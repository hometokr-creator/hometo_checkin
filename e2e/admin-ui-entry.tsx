...
const base: AdminResponse = { id: "response-1", sessionId: "session-1", participant: person, round: "monthly", outcome: "reported", submittedAt: "2026-09-08T01:00:00Z", reviewedAt: null, initiallyPositive: true, labelsAvailable: true,
  timeline: [{ at: "2026-09-08T00:59:00Z", question: "이번 달은 잘 지내셨어요?", answer: "네, 다 괜찮아요" }, { at: "2026-09-08T00:59:40Z", question: "불편에 대해 더 알려주실 내용이 있으면 적어주세요.", answer: "작성함 32자" }], durationSeconds: 60,
...
const fixture: AdminInboxData = { now: "2026-09-08T03:00:00Z", responses: [base,
  ...
  { ...base, id: "okay", participant: { ...person, id: "third", name: "가상 박평온" }, outcome: "ok", issues: [], initiallyPositive: true, reviewedAt: "2026-09-08T02:00:00Z", timeline: [], durationSeconds: null },
