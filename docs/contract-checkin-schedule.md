...
2026-09-18 발신프로필 등록 완료, 템플릿 준비 중. 발송 시각은 한국 시간 오후 2시, 주말·공휴일 포함으로 확정했다. [NHN 연결 안내와 템플릿 초안](nhn-alimtalk-integration.md)을 따른다.
템플릿 승인, 지연 허용, 자동 실행 장치, 공급자 요청·결과/재시도, 실제 발송 시점의 세션/토큰 발급·14일 기한을 연결해야 한다.
